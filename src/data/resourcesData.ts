...
interface GuideResource {
  ...
  guide: [
    ...
    },
    {
      ...
      downloadUrl: "/resources/behavioral-guide.pdf",
    ...
    },
    {
      ...
      downloadUrl: "/resources/system-design.pdf",
      difficulty: "Advanced",
  ...
  video: [
    {
      ...
      videoUrl: "/videos/interview-tips",
    },
    {
      type: 'video',
